...
def make_periodic_table():
    """Devuelve una lista con la tabla periódica. Cada elemento es una tupla:
    (símbolo, nombre, masa atómica)."""
    return [
        ("Ac", "Actinium", 227),
        ("Ag", "Silver", 107.8682),
...
def parse_formula(formula):
    """Parsea la fórmula química y devuelve un diccionario con elementos y sus cantidades."""
    pattern = r"([A-Z][a-z]*)(\d*)"
